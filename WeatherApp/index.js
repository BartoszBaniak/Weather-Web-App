...
const apiKey = "52e7d17fc6520d368c4d87a389d934df";
...
async function getWeatherData(city){
    ...
    if(!response.ok){
        throw new Error("Weather data cannot be downloaded");
    }
...
function displayWeatherInfo(data){
    ...
    descDisplay.textContent = `${description}   ${(temp_min - 273.15).toFixed(1)}°/${(temp_max - 273.15).toFixed(1)}°`;
    ...
    //minTempDisplay.classList.add("minTempDisplay");
...
function getWeatherEmoji(weatherId){
    switch(true){
        ...
        case (weatherId >= 500 && weatherId < 520):
            return "🌦️";
        case (weatherId >= 520 && weatherId < 600):
            return "🌧️";
